<script>
import CatRadio from '../Radio/Radio'
import CatCheckbox from '../Checkbox/Checkbox'
...
export default {
  ...
  methods: {
    ...
    renderCheckIcon (h) {
      return (
        <i class="cat-icon-check cat-cascader-node__prefix"></i>
      )
    },

    renderLoadingIcon (h) {
      return (
        <i class="cat-icon-loading cat-cascader-node__postfix"></i>
      )
    },

    renderExpandIcon (h) {
      return (
        <i class="cat-icon-arrow-right cat-cascader-node__postfix"></i>
      )
    },
    ...
    renderContent (h) {
      ...
      const vnode = render
        ...
        : null
      return (
        <span class="cat-cascader-node__label">{ vnode || node.label }</span>
      )
    }
  },
